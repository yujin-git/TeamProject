...
<%!
	...
	//->클라우드 메시징->서버키 복사
	final String apiKey = "AAAAKpQ58yM:APA91bEkKB4QGfs218eEQwYvpxvaIRqbyky95vliuAPCoE4hXR3IUmBWEunfyProQgxThDbvpQ17C4tWfbOkeVgUaS-pr_eubuyAXqQS3OzaFAJOmKZsW3VGVOLF29R-_6ybuEp7uGEF";
...
<%
    ...
    try {
        ...
        conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl","maven","maven");
