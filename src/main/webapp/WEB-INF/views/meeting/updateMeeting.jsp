      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate mb-0 text-center">
            ...
            <h1 class="mb-0 bread">모임 수정하기</h1>
          </div>
        </div>
      </div>
    </section>
...
<form id="frm" method="post" enctype="multipart/form-data" action="<c:url value='/UpdateMeetingProcess.do'/>">
    ...
    <div class="filebox">
    	<div id="image"
			 ...
			 background-repeat: no-repeat; background-size: cover; background-position:center; background-image: url('/app/images/meeting/${thisMeeting['meetingName']}/${thisMeeting['bannerImg']}');">
	      <div class="overlay"></div>
	      <div class="container">
										...
										<div class="form-inline">
								        	...
								        	<c:forEach var="memberRole" items="${memberRole }">
									        	<c:if test="${thisMeeting['operator'] ne memberRole.id }">
									        		<div>
									        			<input type='text' id='memberRole' name='memberRole' class='form-control' value="${memberRole.roleName }"></input>
									        			<input type='button' style='background-color:#FFB8A8; color:white; border:none; border-radius:5px; height:52px;' value='-' onclick='remove_div(this)'>
									        		</div>
								        		</c:if>
								        	</c:forEach>
								        	</div>
		   ...
		   if (this.files && this.files[0]) {
		       ...
		       reader.onload = function (e) {
		           $("#image").attr('style',
		        		   ...
		        		   +"margin:0 auto; margin-top: 5%; height: 400px; width: 75%;  border: 1px solid gray;"
		      			   +"background-repeat: no-repeat; background-position:center; background-size: cover; ");// 배경으로 지정시
			        }
