...
<body>
   ...
   <div class="container-fluid px-md-12  pt-5 ">
      ...
      <div class="row justify-content-between">
         <div class="col-md-8 offset-2 order-md-last">
            <div class="row">
                     ...
                     <div class="contact-wrap w-100 p-md-5 p-4">
                        <form method="POST" id="frm" name="contactForm"
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-10" style="display: block;margin: 20px 0 20px 0">
                                 <div class="form-group">
                                    <label class="label" for="gender" style="margin-right:20px"> 성별</label>
                              ...
                              <div class="col-md-10" style="display: block;">
                                 <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" name="tel" id="tel" placeholder=" - 를 제외한 숫자만 입력해주세요" maxlength="11"/>
                              ...
                              <div class="col-md-10">
                                 <div class="form-group" style="width:100%;">
                                    <label class="label" style="margin-left:5px;font-size:1.0em">관심분야1</label>
                                    <div class="col-md-6">
                              ...
                              <div class="col-md-10" style="display: none" id='inter2'>
                                 <div class="form-group">
                                    <label class="label" style="margin-left:5px;font-size:1.0em">관심분야2</label>
                                    <div class="col-md-6">
                              ...
                              <div class="col-md-10" style="display: none" id='inter3'>
                                 <div class="form-group">
                                    <label class="label" style="margin-left:5px;font-size:1.0em">관심분야3</label>
                                    <div class="col-md-6">
                                       <select class="form-control" style="float: left;"
                              ...
                              <div class="col-md-10 pt-5">
                                 <div class="form-group">
                                    <input id="joinBtn" type="button" value="회원가입" class="btn btn-success btn-block" style="font-size:1.2em;background-color:#FF7A5C;border-color:#FF7A5C;height:50px">
                                 </div>
                              </div>
                           </div>
                        </form>
