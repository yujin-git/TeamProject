   ...
   <div class="row">
      <div class="col-md-12" style="margin-top: 20px;">
         ...
         <div class="form-group" style="margin-top: 100px;">
            <form id="frm" method="post" enctype="multipart/form-data" action="<c:url value="/InsertBBS.do"/>">
               ...
               <div class="col-sm-12">
                  <div class="row">
                     <div class="col-sm-12">
                        <textarea class="form-control" name="contents" rows="10" placeholder="내용을 입력하세요" id="contents"></textarea>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-sm-12" style="margin-top: 20px;">
                  <a href="javascript:" class="my_button" onclick="submitAction();"><button class="btn col-sm-12" style="background-color: #FF7A5C; width: 1110px; height: 60px; color: white;  border-radius: 25px; font-size:20pt;">업로드</button></a>
               </div>
