			 ...
			 <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">공지사항 등록</h4>
                    </div>
                </div>
            </div>
						...
						<div class="col-12">
							<div class="card">
								<div class="card-body offset-2 col-8">
									<form class="form-horizontal" method="post" id="modalForm" action="<c:url value="/Admin/Notice/WriteProcess.do"/>">
										...
										<div class="form-group">
											<label>내용</label>
											<div>
												<textarea id="summernote" name="content" placeholder="내용 입력하세요"></textarea>
