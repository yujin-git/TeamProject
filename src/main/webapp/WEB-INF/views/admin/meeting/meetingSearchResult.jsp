	...
	<div class="row">
		<div class="col-7 align-self-center">
			<div class="d-flex align-items-center">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb m-0 p-0">
						<li class="breadcrumb-item">모임관리</li>
			...
			<h4
				...
				<a href="<c:url value='/Admin/Meeting/SuspendMeeting.do'/>">정지 모임 조회</a></h4>
										...
										<c:forEach items="${map.searchList}" var="list">
											<tr>
												...
												<td><c:if test="${list.ENABLED eq 0}">
														<a
															href='<c:url value="/Admin/Member/MeetingRelease.do?id=${list.OPERATOR}"/>'>
															해제</a>
